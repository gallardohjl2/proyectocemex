...
var
  ...
  VolTeorico, VolReal: Double;
begin
  Lote := Trim(EditOrdenFab.Text); // Obtener el texto y eliminar espacios
  ...
  DataModule1.ADOQueryBuscar.SQL.Clear;
  DataModule1.ADOQueryBuscar.SQL.Add('SELECT * FROM TotalLab where Lote like '+QuotedStr(Lote+'%'));
  //DataModule1.ADOQueryBuscar.SQL.Add('SELECT * FROM TotalLab WHERE OrdenFab = :OrdenFab');
  ...
  try
    ...
    begin
      ShowMessage('Lote no encontrado.');
    end;
  except
    on E: Exception do
